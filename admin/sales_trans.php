			...
			<div class="container-fluid" style="max-width: 750px;">
				<!-- <div class="container" style="max-width: 1000px;"> -->
					...
					<?php
						...
						while($row=mysqli_fetch_array($query)){
							...
							?>
								...
								<div>
									...
									<div style="margin: 20px 18px 20px 18px;">
						...
						if($inc == 1) echo "<div class='col-lg-6></div><div class='col-lg-6'></div><div class='col-lg-6'></div></div>";
						if($inc == 2) echo "<div class='col-lg-6'></div><div class='col-lg-6'></div></div>";
						if($inc == 3) echo "<div class='col-lg-6'></div></div>";
					?>
					</div>
				<!-- </div> -->
			</div>
